    ...
    if evaluate_rag and "hallucination_score" in df.columns:
        ...
        for model in df['model'].unique():
            ...
            if len(model_df) > 0:
                ...
                best_example = model_df.loc[model_df['hallucination_score'].idxmin()]
                worst_example = model_df.loc[model_df['hallucination_score'].idxmax()]
